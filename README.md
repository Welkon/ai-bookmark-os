...
- 分类数据管理：AI 侧边栏右上角数据入口支持导出/导入分类方案、标签缓存与设置（不含 API Key），导入合并缓存、替换方案并保留本机凭据。
...
1. 在 [v1.0.9 Release](https://github.com/jxh-YG/ai-bookmark-os/releases/tag/v1.0.9) 下载 `ai-bookmark-os-v1.0.9-chrome-extension.zip`。
